...
ADMIN_CATEGORIES = [
    ...
    {
        "key": "image_automod",
        "emoji": emoji.BANNED_IMAGE,
        "label": "Image Automod",
        "blurb": "Ban specific images — sending one gets the message deleted and the sender timed out.",
        "commands": [
            ("-banimage <duration> (as a reply to the image)",
             "Ban the exact image in the message you're replying to. Anyone "
             "who sends it afterward gets the message deleted and is timed "
             "out for <duration> (e.g. `10m`, `1h`, `2d`, `1h30m`). Matching "
             "is exact-file only — a resave/recompress won't match."),
            ("-unbanimage (as a reply, or with a hash prefix)",
             "Un-ban an image — either reply to its original message, or "
             "pass a hash prefix shown in `-listbannedimages`."),
            ("-listbannedimages",
             "List every currently-banned image, its timeout duration, "
